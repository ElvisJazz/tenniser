    ...
    protected function _initialize() {
        ...
        if(session('tennis-user') != null){
            ...
            $logon = ' <li class="dropdown">
                ...
                if($user['is_sign'] == 0)
                    $sign = "<li><a id='signStr' class='btn' onclick='sign0();' >签到</a></li>";
                else
                    $sign = "<li><a id='signStr' class='btn' onclick='sign0();' disabled >已签到</a></li>";
        ...
        $this->assign('pagePostfix', '_'.$this->getClubId());
